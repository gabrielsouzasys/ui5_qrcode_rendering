		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ui5_qrcode_rendering",
									"targetURL": "#ui5qrcoderendering-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5qrcoderendering-display": {
								"semanticObject": "ui5qrcoderendering",
								"action": "display",
								"description": "ui5_qrcode_rendering",
								"title": "ui5_qrcode_rendering",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5qrcoderendering",
									"url": sap.ui.require.toUrl("ui5qrcoderendering")
								}
							}
						}
					}
